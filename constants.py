...
ERROR_NO_ACCOUNT_DATA = 'Не заполнены данные о текущем состоянии счета по объекту!'
...
INFO_PLATEJI_GENERATION_OK = "Генерация списка платежей закончена"
...
DEFAULT_PLATEJI_DIR_PASS = os.getcwd() + '\\Выгрузки\\Платежи\\'
