...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_19.addWidget(self.email_label)
        ...
        self.verticalLayout_19.addWidget(self.email_lineEdit)
    ...
    def retranslateUi(self, Form):
        ...
        self.email_label.setText(QCoreApplication.translate("Form", u"e-mail", None))
